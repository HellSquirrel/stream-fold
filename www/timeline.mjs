...
const css = `
.lf-timeline input[type=range] { width: 100%; }
...
export function timeline(host, container) {
  ...
  container.innerHTML = `<input type="range" min="0" max="0" value="0">
    <p class="lf-meta">the page shows index <span data-at>0</span> · <span data-prov></span> · variables <code data-vars></code></p>
    <div class="lf-lanes"></div>`;
  const scrub = container.querySelector("input");
  const at = container.querySelector("[data-at]"), prov = container.querySelector("[data-prov]");
  const vars = container.querySelector("[data-vars]"), lanes = container.querySelector(".lf-lanes");
